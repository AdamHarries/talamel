...
TALAMEL_C_EXPORT unsigned int tml_count_property_values(tml_TalamelFile *tf,
                                                        const char *key);

TALAMEL_C_EXPORT char *
...
TALAMEL_C_EXPORT char *tml_get_comment(tml_TalamelFile *tf,
